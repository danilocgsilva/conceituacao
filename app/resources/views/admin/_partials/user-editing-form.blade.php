<div class="max-w-7xl mx-auto p-4 sm:p-8 bg-white shadow-md sm:rounded-lg">
    <section>
        ...
        <form class="mt-6 space-y-6">
            ...
            <div>
                <label for="new-password-confirmation" class="block font-medium text-sm text-gray-700">Confirmar nova
                    senha</label>
                <input id="new-password-confirmation" name="new-password_confirmation"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    required type="password" />
