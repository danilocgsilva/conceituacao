    ...
    <div class="max-w-7xl mx-auto p-4 sm:p-8 bg-white shadow-md sm:rounded-lg">
        <section class="space-y-6">
            ...
            <button type="button"
                ...
                onclick="document.getElementById('confirm-user-deletion').style.display='block'">Delete Account</button>
            ...
            <div id="confirm-user-deletion" class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50"
                ...
                <div
                    ...
                    <form method="post" action="/profile" class="p-6">
                        ...
                        <div class="mt-6">
                            <label for="password"
                                class="block font-medium text-sm text-gray-700 sr-only">Password</label>
                        ...
                        <div class="mt-6 flex justify-end">
                            ...
                            <button type="submit"
                                class="ms-3 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 transition duration-200">
                                Delete Account
                            </button>
                        </div>
                    </form>
